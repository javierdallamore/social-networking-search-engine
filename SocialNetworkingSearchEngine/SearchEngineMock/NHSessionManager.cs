using System.Web;
using SearchEngineMock.Mapping;
using NHibernate;
...
namespace SearchEngineMock
{
    public sealed class NHSessionManager
    {
        ...
        {
            connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SearchEngineMockDB"].ConnectionString;
        }
        ...
        private void InitSessionFactory()
        {
            ...
            fc.Mappings(m => m.FluentMappings.AddFromAssemblyOf<SocialNetworkingItemMap>());
